...
import { fileSystem, isId } from "@/utils";
import moment from "moment";
import path from "path";
import { MutationPayload, Commit } from "vuex";
import { NoteMutations } from "./mutations";
import { NoteState, Note } from "./state";
...
export async function serialize(
  s: NoteState,
  { rootState, mutationPayload, commit }: { rootState: any; mutationPayload: MutationPayload; commit: any }
) {
...
export async function saveChangedNotes(rootState: any, commit: any) {
