...
//   UndoSequence,
//   UndoSequenceCommit,
// } from "@/store/plugins/undo/undo-history";
...
//     private _settings: UndoModuleSettings
//   ) {
...
//     const commit: UndoModuleCommiter<M> = (
//       ...args: any[]
//     ): UndoSequenceCommit => {
//       let c;
...
//       } else {
//         c = new UndoSequenceCommit(() =>
//           this._getStore().commit(args[0], args[1])
//         );
//       }
...
//       if (state == null) {
//         throw Error(
//           "No state returned from set state transformer. Did you forget to return the state?"
//         );
//       }
//     }

//     store.commit(
//       `${this._settings.namespace}/${this._settings.setStateAction}`,
//       state
//     );

//     // Reapply (N - 1) mutations to get to the desired state.
//     const [replay, undone] = this._history.undo(
//       cached.index,
