...
describe('Note actions', () => {
    ...
    describe('addNotebook', () => {
        it('commits ADD_NOTEBOOK', () => {
            ...
            expect(commit).toHaveBeenCalledWith('ADD_NOTEBOOK', { value: { note, notebookId: '1' } });
        });
    });
    ...
    describe('addTag', () => {
        it('commits ADD_TAG', () => {
            ...
            expect(commit).toHaveBeenCalledWith('ADD_TAG', { value: { note, tagId: '1' } });
        });
    });
    ...
    describe('removeNotebook', () => {
        it('commits REMOVE_NOTEBOOK', () => {
            ...
            expect(commit).toHaveBeenCalledWith('REMOVE_NOTEBOOK', { value: { note, notebookId: '1' } });
        });
    });
    ...
    describe('removeTag', () => {
        it('commits REMOVE_TAG', () => {
            ...
            expect(commit).toHaveBeenCalledWith('REMOVE_TAG', { value: { note, tagId: '1' } });
        });
    });
});
