import { apply, undo } from '@/features/ui/store/modules/local-navigation/mutations';
import { LocalNavigation, LocalNavigationEvent } from '@/features/ui/store/modules/local-navigation/state';
